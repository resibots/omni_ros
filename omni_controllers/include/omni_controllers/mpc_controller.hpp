...
namespace arm_speed_safe_controller {
    ...
    class MpcController : public controller_interface::Controller<hardware_interface::VelocityJointInterface> {
    public:
        MpcController() {}
        ~MpcController() { _sub_command.shutdown(); }
        ...
        bool init(hardware_interface::VelocityJointInterface* hw, ros::NodeHandle& nh)
        {
            ...
            _sub_mpc = nh.subscribe<omni_controllers::MpcAction>("mpcActions", 1, &MpcController::SetMpcActions, this);
            _serv_reset = nh.advertiseService("manualReset", &MpcController::manualReset, this); //To bring back to default configuration in between episodes
